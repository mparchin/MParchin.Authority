...
namespace MParchin.Authority.TokenFactory
{
    public class AuthorityToken(IJWTFactoryOptions options) : IAuthorityToken
    {
        ...
        [
            ...
            ("emailVerified", (user) => user.EmailVerified.ToString(), (user, value) => user.EmailVerified = value.Equals("true", StringComparison.CurrentCultureIgnoreCase)),
            ("phone", (user) => user.Phone, (user, value) => user.Phone = value),
            ("phoneVerified", (user) => user.PhoneVerified.ToString(), (user, value) => user.PhoneVerified = value.Equals("true", StringComparison.CurrentCultureIgnoreCase)),
